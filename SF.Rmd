...
## Overlap and Intersection with st_overlaps()
...
For the first example on shapefiles
https://www.naturalearthdata.com/downloads/ 

For the second excercise on mapping universities and cities 
https://www.paulamoraga.com/book-spatial/the-sf-package-for-spatial-vector-data.html

For the third excercise on polygons using North Carolina 
