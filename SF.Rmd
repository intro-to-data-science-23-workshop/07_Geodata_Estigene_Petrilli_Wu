...
overlay_map <- mapview(geometry_bocconi_hertie) + mapview(geometry_geocoded_cities)
...
## Gdp per capita Asia and Africa  
Maybe interesting link but idk if they use sf enough https://thinking-spatial.org/courses/angewandte_geodatenverarbeitung/kurs03/ 
